      ...
      <div className="cardcontainer h-[55vh] w-1/2">
        ...
        >
          <img
            ...
            alt=""
          />
          <button className="absolute border-[#CDEA68] text-[#CDEA68]  rounded-full py-0.5 px-1.5 border-2 left-[1.5VW] bottom-[1.5VW]  text-[1.1vw]  tracking-tight font-['nav']">
            ©2019-2022
          </button>
        </div>
      </div>
      ...
      <div className="CardContainer  flex  gap-3 h-[55vh] w-1/2">
        ...
        >
          <img
            ...
            alt=""
          />
          <button className="absolute border-[#c7c5c5] text-[#c7c5c5]  rounded-full py-0.5 px-1.5 border-2 left-[1.5VW] bottom-[1.5VW]  text-[1.1vw]   font-['nav']">
