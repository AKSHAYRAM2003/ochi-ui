...
const Footer = () => {
  return (
    <div className="flex gap-5 w-full h-screen bg-zinc-900 p-20 font-['Founders Grotesk'] text-white">
      <div className="flex flex-col justify-between h-full w-1/2">
        <div className="heading">
          <h1 className="text-[6.5vw] uppercase leading-none  -mb-4 font-semibold font-['hero']">
            Eye-
          </h1>
          <h1 className="text-[6.5vw] uppercase leading-none font-['hero'] -mb-4 font-semibold">
            Opening
          </h1>
        </div>
      ...
      <div className="w-1/2 text-white">
        ...
        <div className="flex justify-between">
          <div className="details font-['nav'] mt-20">
            <a className="block text-xl" href="#">
              Facebook
            </a>
            <a className="block text-xl font-['nav']" href="#">
              Instagram
            </a>
            <a className="block text-xl font-['nav']" href="#">
              Twitter
